  ...
  <div class="carousel-wrap" data-carousel style="margin-top: 1rem;">
    <div class="carousel-track" data-carousel-track>
      ...
      <article class="shot">
        ...
        <p>Clear feedback with strengths, blind spots and immediate priorities.</p>
      </article>
      <article class="shot">
        <h3>Improvement plan</h3>
        <p>Targeted recommendations for your next session.</p>
      </article>
      <article class="shot">
        <h3>Coach personality switch</h3>
        <p>Pick the coaching style that keeps you consistent.</p>
      </article>
    </div>
    <div class="carousel-controls">
